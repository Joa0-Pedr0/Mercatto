...
<h1 class="text-3xl font-bold mb-6">Cadastrar Cliente</h1>
...
<form action="{{ route('customers.store') }}" method="POST"
    ...
    <label class="block">
        CPF:
        <input type="text" name="cpf" class="w-full border p-2 rounded">
    </label>
    ...
    <div class="flex items-center gap-3">
        ...
        <a href="{{ route('customers.index') }}" class="text-blue-600 hover:underline">Voltar</a>
    </div>
</form>
